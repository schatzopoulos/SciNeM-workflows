...
...
```
Note that more details as well as a sample compressed file that contains all the required files for a subset of the DBLP dataset can be found [here](http://scinem.imsi.athenarc.gr/upload).
